...
var _promisePolyfill = __webpack_require__(172);
...
window.io = __webpack_require__(173);
...
var program = function program() {
    var currentScript = document.currentScript || [].slice.call(document.querySelectorAll('script')).filter(function (script) {
        return script.getAttribute('src') && script.getAttribute('src').indexOf('launcher.js') > -1;
    })[0];
    var devtoolsBackendHost = currentScript.src.split('/').slice(2, 3)[0];
    var uuid = currentScript.getAttribute('data-uuid') || document.location.host;
    ...
    var description = (0, _common.getDescription)();
    var title = (0, _common.getTitle)();
    (0, _common.request)('http://' + devtoolsBackendHost + '/register', {
        uuid: uuid,
        url: document.location.href,
        description: description,
        title: title,
     ...
     */
    var origOnReadyStateChange = document.onreadystatechange || NOOP;
    ...
    var origOnError = window.onerror || NOOP;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(84), __webpack_require__(176)))
